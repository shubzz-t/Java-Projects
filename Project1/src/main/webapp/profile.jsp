...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link"
					...
					<li class="nav-item active"><a class="nav-link"
					href="#!" data-toggle="modal" data-target="#add-category"><span class="fa fa-cubes"></span> Add Category <span class="sr-only">(current)</span></a></li>
				...
				<div class="col-md-4">
					<div class="list-group">
						<a href="#" onClick="getPosts(0,this)"
							class=" c-link list-group-item active list-group-item-action"
							aria-current="true">Posts Categories</a>
						<%
						...
						%>
						<a class="c-link list-group-item list-group-item-action" href="#"
							onClick="getPosts(<%=c.getCid()%> , this)"><%=c.getName()%></a>
						<%
						}
						%>
					</div>
	...
	<!-- CATEGORY ADD MODEL -->
	<div class="modal fade mt-5" id="add-category" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
